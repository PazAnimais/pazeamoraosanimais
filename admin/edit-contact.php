          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body" style="text-align:center">
                ...
                $id = $_GET['id'];
                $resPP = mysqli_query($conexao, "select * from contatos where id=$id") or die("Erro na Consulta." . mysqli_error());
                while ($resultado = mysqli_fetch_array($resPP)) {

                ?>

                <h3>Editar contato:</h3> <br><br>

                  <form action="edit-contact1.php" method="POST">

                    <input class="form-control" type="hidden" id="id" name="id" value="<?php echo $resultado['id'] ?>" />
